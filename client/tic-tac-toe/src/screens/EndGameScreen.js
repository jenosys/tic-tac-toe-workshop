...
export default class EndGameScreen extends PIXI.Container {
  ...
  constructor(options = {}) {
    ...
    this.instructionText = new PIXI.Text("touch to close", {
      font: "52px JennaSue",
      fill: 0x000,
      textAlign: 'center'
    })
    ...
    let statuses = `${window.colyseus.username}`
    ...
    this.once('click', this.closeMe.bind(this));
    this.once('touchstart', this.closeMe.bind(this));
